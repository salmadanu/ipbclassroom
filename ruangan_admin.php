                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th class="ruangan__label">Kesersediaan</th>
                            ...
                            <tr>
                                ...
                                <td class="ruangan__data"> 
                                    <form action= "editruangan_page.php" method="post">
                                        ...
                                        <input type="submit" name="editruangan" value="Edit" class="button button--update"/>
                                    </form>
                                    <form action="deleteruangan.php" method="post">
                                        <input type="hidden" name="kode_ruangan" value="<?= $ruangan['kode_ruangan']?>">
                                        <input type="submit" name="deleteruangan" value="Hapus" class="button button--update"/>
                                    </form>
                                </td>
                            </tr>
                            <?php
